    ...
    <div className="w-full py-20">
      ...
      <div className="cards   w-full flex gap-[4vw] pt-[6vw] px-[4.5vw] ">
        ...
        <motion.div
          ...
          className="card relative w-1/2 h-[70vh] "
        >
          <h1 className="absolute  flex overflow-hidden right-full translate-x-1/4  -translate-y-1/2  top-1/2 text-[#CDEA68] z-[9] leading-none tracking-tighter text-[7vw] font-bold">
            {"VISE_".split("").map((item, index) => (
              <motion.span
                initial={{ y: "100%" }}
                animate={cards[1]}
                transition={{ ease: [0.22, 1, 0.36, 1], delay: index * 0.06 }}
